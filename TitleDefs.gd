...
const TITLES := [
	...
	{"id": "species3", "name": "세 종의 기록", "stat": "gold", "levels": 2,
		"conds": [{"kind": "species", "n": 3}]},
	{"id": "species5", "name": "다섯 종의 기록", "stat": "gold", "levels": 3,
		"conds": [{"kind": "species", "n": 5}]},
	{"id": "species8", "name": "여덟 종의 기록", "stat": "gold", "levels": 4,
		"conds": [{"kind": "species", "n": 8}]},
	{"id": "species10", "name": "열 종의 기록", "stat": "gold", "levels": 5,
		"conds": [{"kind": "species", "n": 10}]},
	{"id": "species12", "name": "열두 종의 기록", "stat": "gold", "levels": 6,
		"conds": [{"kind": "species", "n": 12}]},
	{"id": "species15", "name": "열다섯 종의 기록", "stat": "gold", "levels": 7,
		"conds": [{"kind": "species", "n": 15}]},
	{"id": "species18", "name": "18 종의 기록", "stat": "gold", "levels": 8,
		"conds": [{"kind": "species", "n": 18}]},
	{"id": "species20", "name": "스무 종의 기록", "stat": "gold", "levels": 9,
		"conds": [{"kind": "species", "n": 20}]},
	{"id": "species22", "name": "22 종의 기록", "stat": "gold", "levels": 10,
	...
	{"id": "traits3", "name": "핏줄 3갈래", "stat": "gold", "levels": 2,
		"conds": [{"kind": "traits", "n": 3}]},
	{"id": "traits6", "name": "핏줄 6갈래", "stat": "gold", "levels": 3,
		"conds": [{"kind": "traits", "n": 6}]},
	{"id": "traits9", "name": "핏줄 9갈래", "stat": "gold", "levels": 4,
		"conds": [{"kind": "traits", "n": 9}]},
	{"id": "traits12", "name": "핏줄 12갈래", "stat": "gold", "levels": 5,
		"conds": [{"kind": "traits", "n": 12}]},
	{"id": "traits16", "name": "핏줄 16갈래", "stat": "gold", "levels": 7,
		"conds": [{"kind": "traits", "n": 16}]},
	{"id": "traits20", "name": "핏줄 20갈래", "stat": "gold", "levels": 8,
		"conds": [{"kind": "traits", "n": 20}]},
	{"id": "traits24", "name": "핏줄 24갈래", "stat": "gold", "levels": 9,
		"conds": [{"kind": "traits", "n": 24}]},
	{"id": "traits28", "name": "핏줄 28갈래", "stat": "gold", "levels": 10,
	...
	{"id": "pair1", "name": "피맛", "stat": "gold", "levels": 4,
	...
	{"id": "pair7", "name": "핏줄 각성", "stat": "gold", "levels": 4,
	...
	{"id": "pair12", "name": "탐식", "stat": "gold", "levels": 7,
	...
	{"id": "pair16", "name": "피의 계보", "stat": "gold", "levels": 8,
