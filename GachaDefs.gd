...
const RARITIES := [
	{"key": "common", "name": "일반", "power": 1.0, "weight": 50.0,
		"col": Color(0.72, 0.72, 0.76)},
	{"key": "uncommon", "name": "고급", "power": 1.35, "weight": 30.0,
		"col": Color(0.42, 0.82, 0.55)},
	{"key": "rare", "name": "희귀", "power": 1.8, "weight": 14.0,
		"col": Color(0.45, 0.62, 1.0)},
	{"key": "epic", "name": "영웅", "power": 3.2, "weight": 5.0,
		"col": Color(0.72, 0.45, 0.95)},
	{"key": "legend", "name": "전설", "power": 5.5, "weight": 1.0,
