...
const LIMITED := [
	...
	{"id": "ltd_maze", "name": "오늘의 미궁 특가", "price": 3300, "value": 320,
		"desc": "혈정 1800",
		"reward": {"crystal": 1800.0}},
	{"id": "ltd_oath", "name": "오늘의 계약 특가", "price": 3300, "value": 320,
		"desc": "계약 카드 6장 · 황금 계약 2장",
		"reward": {"oath_card": 6.0, "oath_gold": 2.0}},
	# 던전 입장권 (2026-09-10 사장님: "캐시템에 재화 던전 입장권도 추가").
	# 여기서도 파는 것은 **시간**이다 — 표는 자정이면 어차피 돌아오고, 이건
	# 그 사흘을 앞당긴다. 상점이 같은 물건을 하루 1회 60보석에 팔고 있어서
	# 3회 = 180보석이 기준이고, 나머지는 혈정으로 채워 다른 특가와 값을 맞춘다.
	{"id": "ltd_raid", "name": "오늘의 던전 특가", "price": 3300, "value": 320,
		"desc": "던전 입장권 3회 · 혈정 900",
		"reward": {"raid_pass": 3.0, "crystal": 900.0}},
]
