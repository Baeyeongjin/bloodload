...
func _init() -> void:
	...
	var boxes := [
		...
		["999.9t", Type.SIZE_SMALL, 96.0, "상단 재화 알약"],
		# 전투력 칸: 초상화 밑, 가운데 덩어리(132부터) 직전까지 126px
		["전투력 999.9t", Type.SIZE_SMALL, 126.0, "상단 전투력 칸"],
		["레벨 999999", Type.SIZE_SMALL, 126.0, "초상화 레벨 칸"],
		...
		# 가운데 덩어리: 폭 306
		["100-10 · 처치 60 / 60 · 60초", Type.SIZE_SMALL, 306.0, "상단 진행 줄"],
		["깨어난 무덤", Type.SIZE_BODY, 306.0, "상단 막이름 줄"],
