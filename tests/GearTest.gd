...
func _init() -> void:
	...
	var boxes := [
		...
		# 재화 바: 폭 340 - 좌우 여백 16 = 324, 3칸이니 한 칸 108, 아이콘 26을 빼면 80
		["999.9t", Type.SIZE_SMALL, 80.0, "재화 바 한 칸"],
		# 레벨 배지 96 - 좌우 여백 6씩 = 84
		["레벨 9999", Type.SIZE_SMALL, 84.0, "초상화 레벨 배지"],
		# 가이드 카드: 보상 칸 구멍 48px / 오른쪽 목표·진행바 칸 134px
		["999t", Type.SIZE_SMALL, 48.0, "가이드 보상 수량(소수점 없음)"],
		["공격력 훈련", Type.SIZE_SMALL, 122.0, "가이드 목표 줄(트랙 이름)"],
		["받기 9999개", Type.SIZE_SMALL, 122.0, "가이드 수령 안내"],
		["999k/999k", Type.SIZE_SMALL, 122.0, "가이드 진행바 숫자"],
		["가이드 9999", Type.SIZE_SMALL, 108.0, "가이드 헤더 탭"],
		# 가운데 덩어리: 폭 306
		# 가운데 덩어리 = 576 - 148(왼쪽 블록) - 20(오른쪽 여백) = 408
		# 진행바 글자 칸 = 408 - 좌우 화살촉(26 x 2) = 356
		["처치 60 / 60 · 60초", Type.SIZE_SMALL, 356.0, "진행바 글자(홈통 안)"],
		["깨어난 무덤 100-10", Type.SIZE_BODY, 408.0, "상단 막이름 줄"],
